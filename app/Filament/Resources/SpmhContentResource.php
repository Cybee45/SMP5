...
use App\Filament\Resources\SpmhContentResource\RelationManagers;
...
class SpmhContentResource extends Resource
{
    ...
    {
        return Auth::user()?->can('spmhcontent_view') ?? false;
    }

    public static function canCreate(): bool
    {
        return Auth::user()?->can('spmhcontent_create') ?? false;
    }

    public static function canEdit($record): bool
    {
        return Auth::user()?->can('spmhcontent_edit') ?? false;
    }

    public static function canDelete($record): bool
    {
        return Auth::user()?->can('spmhcontent_delete') ?? false;
    }
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                // Konten untuk Formulir
                Forms\Components\Section::make('File Formulir')
                    ->description('Upload file PDF formulir pendaftaran yang dapat diunduh calon siswa')
                    ->schema([
