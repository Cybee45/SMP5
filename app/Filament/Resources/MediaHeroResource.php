...
class MediaHeroResource extends Resource
{
    ...
    /* Akses */
    public static function canViewAny(): bool   { return Auth::user()?->can('cms_media') ?? false; }
    public static function canAccess(): bool    { return static::canViewAny(); }
    public static function canCreate(): bool    { return Auth::user()?->can('cms_media') ?? false; }
    public static function canEdit($record): bool   { return Auth::user()?->can('cms_media') ?? false; }
    public static function canDelete($record): bool { return Auth::user()?->can('cms_media') ?? false; }
    ...
    /** Pakai uuid_id untuk route binding di URL */
