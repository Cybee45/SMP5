...
use App\Support\OrderField;use App\Filament\Resources\HeroBlogResource\Pages;
            ...
            ->schema([
                Forms\Components\Section::make('Hero Blog Information')
                    ->schema([
                        ...
                        // HANYA gambar utama yang dipakai
                        Forms\Components\FileUpload::make('gambar_utama')
                            ->label('Gambar Utama')
                            ->image()
                            ->directory('hero-blog'),

                        Forms\Components\OrderField::make('hero_blogs', 'Urutan')
                            ->label('Urutan')
                            ->numeric()
                            ->minValue(1)
                            ->required()
