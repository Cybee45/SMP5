...
use App\Support\OrderField;use App\Filament\Resources\FooterSettingResource\Pages;
                        ...
                        Forms\Components\Repeater::make('menu_items')
                            ->schema([
                                ...
                                Forms\Components\Toggle::make('aktif')
                                    ->default(true),
                                Forms\Components\OrderField::make('footer_settings', 'Urutan')
                                    ->numeric()
                                    ->minValue(1)
                                    ->default(1),
                            ])
                ...
                Forms\Components\Section::make('Pengaturan')
                    ->schema([
                        ...
                        Forms\Components\OrderField::make('footer_settings', 'Urutan')
                            ...
                            ->minValue(1)
                            ->required()
                            ->default(fn () => (\App\Models\FooterSetting::max('urutan') ?? 0) + 1),
                    ])->columns(3),
            ]);
    }
