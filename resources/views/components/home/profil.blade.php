  ...
  <div class="container mx-auto px-6 md:px-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
      ...
      <div class="relative z-10">
        ...
        <!-- Teks dengan spasi antar paragraf yang lebih baik -->
        ...
        <!-- Tombol yang didesain ulang dengan ikon -->
        <a href="#" class="mt-8 inline-flex items-center gap-x-3 bg-[var(--color-brand)] text-white font-semibold rounded-lg px-6 py-3 shadow-lg hover:bg-[var(--color-brand-dark)] transition-all duration-300 transform hover:scale-105">
