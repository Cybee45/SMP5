<section id="hero" class="relative min-h-screen bg-white flex items-center overflow-hidden pt-20 sm:pt-24 md:pt-0">
  ...
  <div class="max-w-[88rem] w-full relative z-20 mx-auto flex flex-col-reverse items-center gap-y-4 sm:gap-y-6 md:gap-y-8 px-4 sm:px-6 md:px-8 pt-24 lg:pt-28 pb-24 lg:flex-row lg:gap-x-16 lg:pl-12 xl:pl-24">
    ...
    <div class="w-full space-y-5 text-left lg:w-5/12 mt-4 lg:mt-0" data-aos="fade-right" data-aos-delay="300" data-aos-duration="900">
      ...
      <h1 class="text-4xl lg:text-5xl xl:text-6xl font-black leading-tight text-gray-900 font-heading">Belajar, berprestasi, dan raih ilmu untuk masa depan</h1>
      <p class="text-base md:text-lg text-slate-600 max-w-[48rem]">Kita ciptakan lingkungan belajar yang patut diacungi jempol. Siswa semangat mendalami ilmu—gerbang sekolah adalah awal perjalananmu.</p>
      <a href="/spmb" class="inline-block rounded-full bg-white px-8 py-4 text-base font-bold text-[var(--color-brand-dark)] shadow-xl hover:-translate-y-1 hover:shadow-2xl transition-all duration-500 ease-in-out">Cek SPMB</a>
    </div>
