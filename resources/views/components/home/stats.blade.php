<section class="bg-slate-50 py-20 lg:py-24">
  <div class="container mx-auto px-6 md:px-8">
    ...
    <!--
      Grid Utama dengan Dua Kolom
      - Diubah menjadi 12 kolom (`lg:grid-cols-12`) untuk kontrol posisi yang lebih baik.
    -->
    <div class="grid grid-cols-1 items-center gap-y-12 lg:grid-cols-12 lg:gap-x-12">

      <!-- 
        Kolom Kiri: Logo dan Judul
        - `lg:col-span-5`: Mengambil 5 dari 12 kolom.
        - `lg:col-start-2`: Mulai dari kolom ke-2, menciptakan margin di kiri.
      -->
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-10 lg:col-span-5">
        ...
        <div class="flex items-center gap-x-4">
          <div class="flex-shrink-0 text-sky-600">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
              <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
            </svg>
          </div>
          <div>
            <p class="text-4xl font-extrabold tracking-tight text-gray-900">960</p>
            <p class="mt-1 text-sm font-medium text-slate-500">Siswa Aktif</p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-x-4">
          ...
          <div>
            <p class="text-4xl font-extrabold tracking-tight text-gray-900">55</p>
            <p class="mt-1 text-sm font-medium text-slate-500">Guru Profesional</p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-x-4">
          ...
          <div>
            <p class="text-4xl font-extrabold tracking-tight text-gray-900">4,800+</p>
            <p class="mt-1 text-sm font-medium text-slate-500">Alumni Tersebar</p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-x-4">
          ...
          <div>
            <p class="text-4xl font-extrabold tracking-tight text-gray-900">125+</p>
            <p class="mt-1 text-sm font-medium text-slate-500">Raihan Prestasi</p>
          </div>
        </div>
