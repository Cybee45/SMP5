    ...
    <section id="kontak-dan-lokasi" class="bg-white">
        <div class="container mx-auto px-4 py-16 md:py-24">
            ...
            <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <!-- Kartu 1: Email Utama -->
                <div class="bg-gray-50 border border-gray-200 rounded-2xl p-8 group hover:bg-blue-50 hover:shadow-lg transition-all duration-300"
                     data-aos="fade-up"
                    ...
                    <div class="flex items-start">
                        <div class="flex-shrink-0 bg-blue-100 text-blue-600 rounded-lg p-3 transform transition-transform duration-300 group-hover:scale-110">
                ...
                <!-- Kartu 2: Telepon & WhatsApp -->
                <div class="bg-gray-50 border border-gray-200 rounded-2xl p-8 group hover:bg-green-50 hover:shadow-lg transition-all duration-300"
                     data-aos="fade-up"
                     data-aos-duration="700"
                     data-aos-delay="350"
                     data-aos-anchor-placement="top-bottom"
                     data-aos-easing="ease-out-cubic">
                    <div class="flex items-start">
                        <div class="flex-shrink-0 bg-green-100 text-green-600 rounded-lg p-3 transform transition-transform duration-300 group-hover:scale-110">
                ...
                <!-- Kartu 3: Lokasi & Peta Terintegrasi -->
                 <div class="bg-gray-50 border border-gray-200 rounded-2xl p-6 md:p-8 md:col-span-2 overflow-hidden group hover:shadow-lg transition-all duration-300"
                      data-aos="fade-up"
                      data-aos-duration="800"
                      data-aos-delay="500"
                      data-aos-anchor-placement="top-bottom"
                      data-aos-easing="ease-out-cubic">
                    <div class="flex items-start">
                        <div class="flex-shrink-0 bg-purple-100 text-purple-600 rounded-lg p-3 transform transition-transform duration-300 group-hover:scale-110">
